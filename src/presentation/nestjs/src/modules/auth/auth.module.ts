...
@Module({
    ...
    providers: [
        ...
        { provide: ConfigPort, useClass: EnvConfigService },
        {
            provide: 'ITokenService', useFactory: (config: ConfigPort) =>
                new JwtTokenService(
        ...
        { provide: 'IRefreshTokenRepository', useClass: RefreshTokenRepositoryTypeORM },
        {
        ...
        },
        {
            ...
            ) => new LoginAuthUseCase(userRepo, hash, uuid, token, config, refreshService),
            inject: ['IUserRepository', 'IHashService', 'IUuidService', 'ITokenService', ConfigPort, RefreshTokenService],
        },
    ],
    exports: []
})
