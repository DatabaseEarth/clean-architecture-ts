...
export const validateMessage = {
  ...
  uuid: (fieldName: string) => `${fieldName} phải là một chuỗi UUID hợp lệ.`,

  string: (fieldName: string) => `${fieldName} phải là một chuỗi ký tự.`,

  length: (fieldName: string, from: number, to: number) =>
    `${fieldName} phải là một chuỗi ký tự từ ${from} đến ${to}.`,
  ...
  afterOrEqual: (
    ...
    `${fieldName} phải sau hoặc bằng ngày ${
      typeof date === "string"
        ? date
        : date.format(allowTime ? "YYYY-MM-DD HH:mm:ss" : "YYYY-MM-DD")
    }.`,

  afterNow: (fieldName: string) => `${fieldName} phải là ngày sau hiện tại.`,

  afterOrEqualNow: (fieldName: string) =>
    `${fieldName} phải là ngày sau hoặc bằng hiện tại.`,

  before: (fieldName: string, date: IDateTime | string, allowTime?: boolean) =>
    `${fieldName} phải trước ngày ${
      typeof date === "string"
        ? date
        : date.format(allowTime ? "YYYY-MM-DD HH:mm:ss" : "YYYY-MM-DD")
    }.`,
  ...
  beforeOrEqual: (
    ...
    `${fieldName} phải trước hoặc bằng ngày ${
      typeof date === "string"
        ? date
        : date.format(allowTime ? "YYYY-MM-DD HH:mm:ss" : "YYYY-MM-DD")
    }.`,

  beforeNow: (fieldName: string) => `${fieldName} phải là ngày trước hiện tại.`,

  beforeOrEqualNow: (fieldName: string) =>
    `${fieldName} phải là ngày trước hoặc bằng hiện tại.`,
